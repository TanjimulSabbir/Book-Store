        ...
        <nav className="py-4 2xl:px-6 bg-teal-500 text-black">
            <div className="container flex items-center justify-between">
                ...
                <form className="flex items-center relative" onSubmit={handleForm}>
                    <div className="group relative rounded-md bg-white border-black">
                        <svg width="20" height="20" fill="currentColor"
                            className="absolute left-3 top-1/2 -mt-2.5 text-slate-800 pointer-events-none group-focus-within:text-primary">
                        ...
                        <input onChange={(event) => dispatch(searchInput(event.target.value))}
                            name="searchBox"
                            type="text" placeholder="Filter books..." className="search cursor-text " id="lws-search" />
                    </div>
                    <button type="submit"
